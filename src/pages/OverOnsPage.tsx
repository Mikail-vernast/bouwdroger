...
/**
 * Over ons — 1:1 transcription of the Claude Design handoff
 * (Over Ons.html). The design's own header/footer are replaced by the
 * shared <V3Header>/<V3Footer>; everything else is the design's markup,
 * scoped under `.ov-page` (see src/styles/over-ons.css). Assets resolve
 * from /vernast/*.webp.
 */

const OverOnsPage = () => {
  // Het contactformulier toont in de bron na "Verstuur" een dankboodschap.
  // We rerenderen dat met state, maar de begintoestand (formBody zichtbaar)
  // wordt méé geprerenderd, zodat de inhoud er ook zonder JS staat.
  ...
  return (
    <div className="ov-page">
      ...
      <section className="ov-hero">
        <div className="wrap">
          <span className="kick">Over Vernast BouwDroging</span>
          <h1>Bouwdroging,<br />opnieuw uitgedacht.</h1>
          <p>Een bouwdroger huren zou eenvoudig moeten zijn. Daarom maken wij bouwdroging eenvoudiger, transparanter en technisch beter onderbouwd: de juiste capaciteit, duidelijke afspraken en zo weinig mogelijk zorgen voor u.</p>
        </div>
        <div className="ov-stage">
          ...
          <img className="ov-team" src="/vernast/team-drie.webp" alt="Het Vernast team" />
        </div>
      </section>
      ...
      <section className="prak">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="sec">Wij leveren geen toestellen af. Wij leveren een droog resultaat.</h2>
          </div>
          <div className="prak-grid">
            <div className="prak-copy">
              <p>Bij de meeste verhuurders eindigt het verhaal wanneer het toestel geleverd is. Bij ons begint het daar pas. Uw chape moet klaar zijn voor de vloerder, uw pleisterwerk voor de schilder, uw woning voor de oplevering. <b>Dáár werken wij naartoe.</b></p>
              <p>Daarom berekenen we eerst wat uw situatie echt nodig heeft. Pleister, chape en beton geven vocht elk op hun eigen tempo af, en <b>temperatuur, luchtcirculatie en laagdikte</b> bepalen mee hoe snel. Wie dat negeert, droogt te traag of verspilt energie.</p>
              <p>Die kennis halen we niet uit een brochure. Vernast staat dagelijks op werven voor <b>vochtbestrijding, afwerking en isolatie</b>. Wij zien wat er fout loopt wanneer er verkeerd gedroogd wordt, en bouwden onze droogservice om precies dat te vermijden.</p>
            </div>
            <div className="qcard">
              ...
              <ul>
                <li><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Welke oplossing geschikt is voor uw materiaal en situatie.</li>
                <li><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Welke capaciteit nodig is, berekend op volume en toepassing.</li>
                <li><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Wat u mag verwachten: droogtijd, verloop en eindresultaat.</li>
                <li><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Welke kosten eraan verbonden zijn, in één duidelijke prijs.</li>
                <li><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> En hoe het droogproces wordt opgevolgd, tot de eindmeting.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="team" id="team">
        <div className="wrap">
          <div className="sec-head mid">
            ...
            <h2 className="sec">Geen klassiek verhuurbedrijf. Eén team met vier vakgebieden.</h2>
            <p className="lede">Onze manier van werken ontstaat door disciplines samen te brengen. Allemaal met hetzelfde doel: de complexiteit achter de schermen oplossen, zodat het voor u eenvoudig wordt.</p>
          </div>
          <div className="team-grid">
            <div className="tm">
              <div className="tphoto"><img src="/vernast/man-klembord.webp" alt="Bouwtechniek" /></div>
              <div className="tbody">
                <h3>Bouwtechniek</h3>
            ...
            <div className="tm">
              <div className="tphoto"><img src="/vernast/worker-thumb.webp" alt="Productontwikkeling" /></div>
              <div className="tbody">
            ...
            <div className="tm">
              <div className="tphoto"><img src="/vernast/koppel-digitaal.webp" alt="Softwareontwikkeling" /></div>
              <div className="tbody">
            ...
            <div className="tm">
              <div className="tphoto"><img src="/vernast/man-zen-crop.webp" alt="Marketing en klantbeleving" /></div>
              <div className="tbody">
          ...
          <div className="belg">
            ...
            <img src="/vernast/drie-vakmannen.webp" alt="Vernast vakmannen" />
          </div>
        </div>
      </section>
      ...
      <section className="fase" id="vacatures">
        <div className="wrap fase-grid">
          <div>
            ...
            <h2 className="sec">Bouw jij mee aan de nieuwe standaard in bouwdroging?</h2>
            <p className="lede">Vernast groeit, en dat voel je op de baan. We zoeken collega's met technisch inzicht en goesting om klanten echt te helpen: van installatie en vochtmeting tot ophaling. Ervaring in de bouw is een plus, de rest leer je bij ons.</p>
            <div className="fase-chips">
              <span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Vast contract</span>
              <span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Interne opleiding &amp; certificering</span>
              <span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Modern materiaal &amp; eigen wagen</span>
              <span><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg> Hecht team, korte lijnen</span>
            </div>
          </div>
          <div className="jobs">
      ...
      <section className="tech">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="sec">Technologie met één functie: complexiteit wegnemen.</h2>
          </div>
        </div>
        <div className="mq">
          <div className="mq-track">
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" /><path d="M8 6h8" /><path d="M8 10h8" /><path d="M8 14h4" /></svg> Technische capaciteitsselectie</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18" /><path d="m7 15 4-6 4 3 5-8" /></svg> Berekening ruimte &amp; toepassing</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4" /><path d="M8 2v4" /><path d="M3 10h18" /></svg> Digitale reservatie</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 18H3V8h11v10H9" /><path d="M14 10h4l3 4v4h-2" /><circle cx="7" cy="18" r="2" /><circle cx="17" cy="18" r="2" /></svg> Planning &amp; logistiek</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg> Projectopvolging</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" /><path d="M8 6h8" /><path d="M8 10h8" /><path d="M8 14h4" /></svg> Technische capaciteitsselectie</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18" /><path d="m7 15 4-6 4 3 5-8" /></svg> Berekening ruimte &amp; toepassing</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4" /><path d="M8 2v4" /><path d="M3 10h18" /></svg> Digitale reservatie</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 18H3V8h11v10H9" /><path d="M14 10h4l3 4v4h-2" /><circle cx="7" cy="18" r="2" /><circle cx="17" cy="18" r="2" /></svg> Planning &amp; logistiek</span>
        ...
        <div className="mq rev">
          <div className="mq-track">
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10" /></svg> Technische protocollen</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 12 2 2 4-4" /><circle cx="12" cy="12" r="10" /></svg> Kwaliteitscontrole</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /></svg> Documentatie &amp; rapportage</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2 3 14h7l-1 8 10-12h-7z" /></svg> Automatisering droogproces</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12h4l3-9 4 18 3-9h6" /></svg> Digitale monitoring (binnenkort)</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10" /></svg> Technische protocollen</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 12 2 2 4-4" /><circle cx="12" cy="12" r="10" /></svg> Kwaliteitscontrole</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /></svg> Documentatie &amp; rapportage</span>
            <span className="it"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2 3 14h7l-1 8 10-12h-7z" /></svg> Automatisering droogproces</span>
        ...
        <div className="wrap">
          <p className="tech-note">Technologie is bij ons geen doel op zich. Ze heeft één taak: <b>u werk uit handen nemen</b>. U berekent, boekt, betaalt en plant uw installatie volledig online, en u weet op elk moment wat er op uw werf gebeurt.</p>
        </div>
      </section>
      ...
      <section className="acy" id="academy">
        <div className="wrap acy-grid">
          <div>
            ...
            <h2 className="sec">Vernast Academy.</h2>
            <p className="lede">Goede apparatuur zonder goede uitvoering lost weinig op. Daarom bouwen we aan de Vernast Academy: ons interne opleidingsprogramma met trainingen en certificaten rond de nieuwste droogtechnieken. De Academy wordt nog volop uitgewerkt, maar één ding geldt vandaag al op elke werf: <b style={{ color: "#fff" }}>iedere vakman die bij u installeert, is intern opgeleid en gecertificeerd</b>. Zo krijgt u overal dezelfde aanpak en dezelfde kwaliteit.</p>
            <div className="acy-stats">
            ...
            <a className="btn btn-white" href="https://www.vernast.be/academy" style={{ marginTop: "30px" }}>Ontdek de Academy op vernast.be
      ...
      <section className="groep">
        <div className="wrap">
          <div className="sec-head">
            ...
            <h2 className="sec">Eén groep. Alles rond uw gebouw.</h2>
      ...
      <section className="oform" id="formulier">
        <div className="wrap">
          <div className="sec-head mid" style={{ textAlign: "center", marginLeft: "auto", marginRight: "auto" }}>
            <span className="kick">Vragen of samenwerken?</span>
            <h2 className="sec" style={{ color: "#fff" }}>Vertel ons waar u mee zit.</h2>
            <p className="lede" style={{ color: "rgba(255,255,255,.78)", marginLeft: "auto", marginRight: "auto" }}>Een vraag over onze aanpak, een project bespreken of solliciteren: u krijgt binnen één werkdag antwoord.</p>
          </div>
          <div className="fshell">
            <div id="formBody" style={{ display: verzonden ? "none" : undefined }}>
              <div className="frow">
              ...
              <div className="fsend">
                ...
                <button className="btn btn-red2" id="fSend" type="button" onClick={() => setVerzonden(true)}>Verstuur bericht<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></button>
              </div>
            </div>
            <div className={verzonden ? "fdone on" : "fdone"} id="formDone">
